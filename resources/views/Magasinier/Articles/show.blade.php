        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex m-2 p-2">
                <a href="{{ route('magasinier.articles.index') }}"
                    class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Show article </a>
            </div>
                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="" action=""
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div>
                            <img src="{{ Storage::url($article->image_art) }}" class="w-32 h-32">
                            </div>
                            @error('image_art')
                                <div class="text-sm text-red-400">{{ $message }}</div>
                            @enderror
            ...
            <a class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white" href="{{ route('magasinier.articles.index') }}"> Back</a>
        </div>
                </div>
