    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-end m-2 p-2">
                <a href="{{ route('magasinier.articles.create') }}"
                                        ...
                                        <td
                                            ...
                                            <td
                                                ...
                                                <div class="flex space-x-2">
                                                    <a href="{{ route('magasinier.articles.edit', $article->id) }}"
                                                        class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg  text-white">Edit</a>
                                                        <a href="{{ route('magasinier.articles.show', $article->id) }}"
                                                        class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg  text-white">Show</a>
                                                    <form
                                                        class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white"
                                                        method="POST"
                                                        action="{{ route('magasinier.articles.destroy', $article->id) }}"
