        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="m-2 p-2 bg-slate-100 rounded">
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form method="" action="{{ route('chef_service.demande_de_sorties.show', $demande_de_sortie->id) }}"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input type="number"min="0.00" max="10000.00" step="0.01" id="qte_sort" name="qte_sort" value="{{ $demande_de_sortie->qte_sort }}"
                                    class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            </div>
                            @error('qte_sort')
                                <div class="text-sm text-red-400">{{ $message }}</div>
            ...
            <a class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white" href="{{ route('chef_service.demande_de_sorties.index') }}"> Back</a>
        </div>
                </div>
